...
if(isset($_GET['code'])){ 
    ...
    if(!empty($event_id)){ 
        ...
        if(!empty($eventData)){ 
            ...
            $attendees = json_decode($eventData['attendees']);
            ...
            if(!empty($access_token)){
                try { 
                    ...
                    $google_event_id = $GoogleCalendarApi->CreateCalendarEvent($access_token, 'primary', $calendar_event, 0, $event_datetime, $user_timezone, $attendees); 
