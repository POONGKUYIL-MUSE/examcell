...
class GoogleCalendarApi { 
    ...
    public function CreateCalendarEvent($access_token, $calendar_id, $event_data, $all_day, $event_datetime, $event_timezone, $attendees) { 
        ...
        // $curlPost['attendees'] = [
        //     ['email' => ['poongkuyilmuse@gmail.com']],
        //     ['email' => ['musepoongkuyil@gmail.com']],
        // ];

        foreach ($attendees as $attendee) {
            $t = [];
            $t['email'] = [$attendee];
            array_push($curlPost['attendees'], $t);
        }

        $curlPost['sendUpdates'] = array("sendUpdates" => "all");
        // $curlPost['reminders'] = array('useDefault' => true, 'overrides' => array('method' => 'email', 'minutes' => 5));
