        ...
        <div class="row flex-nowrap">
            ...
            <div class="after-side-content col py-5 px-5"> 
                ...
                <?php
                        ...
                        ?>  
                    <form id="staff_form" action="controller.php" method="POST" class="p-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo isset($staff['firstname'])?$staff['firstname']:''; ?>" required autofocus>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="<?php echo isset($staff['email'])?$staff['email']:''; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
